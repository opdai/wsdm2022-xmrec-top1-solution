...
from i2iv2Params import walk_length,num_walks,workers,_p,_q,vector_size,window,sg,hs,negative
...
def main():
    ...
    spath = '/home/workspace/OUTPUT/00_NEW/i2i_bfs_novalid_maxpooling'
